...
(5, 'Anello Hyperbola', 'Questo anello Hyperbola intrecciato integra più stili in un unico design meravigliosamente compatto. Le sue due fasce placcate rodio sovrapposte sono impreziosite da LaVita Jewelry Zirconia trasparenti con montature a binario e a griffe. Un cristallo aggiuntivo taglio Oval è inframmezzato per un impatto aggiuntivo. Abbinalo ad un bangle coordinato per un look davvero mozzafiato.', 50, 140, 'f', 'assets/img/anello2.jpg', 'anelli'),
...
(8, 'Bracciale Millenia', 'Trova il divertimento nella moda con questo gioioso bracciale Millenia blu, che contiene almeno il 30% di LaVita Jewelry ReCreated™ crystals, i nostri cristalli più sostenibili ad oggi. La creazione è placcata rodio e presenta una vivace sfumatura di cristalli taglio Octagon. Affascinante ed espressivo, questo bracciale è perfetto per le giornate che meritano un tocco di colore vivace.', 30, 250, 'f', 'assets/img/bracciale2.jpg', 'bracciali'),
...
(10, 'Orecchini a lobo Matrix', 'Questi straordinari orecchini a buco sono una fresca interpretazione del classico orecchino con perla. Ciascuna creazione placcata rodio presenta un’unica Crystal Pearl LaVita Jewelry bianca e una LaVita Jewelry Zirconia taglio Round, collegate tra loro per dare vita a un insieme lussuoso e lucente. Indossali con un pendente Matrix coordinato per amplificare la radiosità.', 40, 80, 'f', 'assets/img/orecchini1.jpg', 'orecchini'),
(11, 'Orecchini a lobo Constella', 'Preparati a risplendere con questi incantevoli orecchini a lobo della linea Constella. Questo irresistibile paio, che esibisce pietre trasparenti illuminate dalla squisita tecnica pavé LaVita Jewelry, è rifinito da una montatura placcata rodio. Instant wonder per ogni giorno.', 10, 100, 'f', 'assets/img/orecchini2.jpg', 'orecchini'),
...
-- Insert values into 'ordine' table
INSERT INTO orders (id, date, totalCost, userEmail) VALUES
(1, '2025-01-10', 560.00, 'mario@gmail.com'),  -- Collana Infinity + Collana Mesmera + Orecchini pendenti Mesmera
(2, '2025-02-15', 1600.00, 'luigi@gmail.com'),  -- 2 * Collana Gema + Orecchini a lobo Constella
(3, '2025-03-20', 240.00, 'musano@gmail.com'),  -- Anello Vittore + Orecchini a lobo Matrix
(4, '2025-04-25', 340.00, 'ivano@gmail.com'),  -- Anello Hyperbola + Bracciale Mesmera
(5, '2025-05-30', 660.00, 'mario@gmail.com');   -- Anello Cocktail Lucent + Bracciale Angelic + Bracciale Millenia
